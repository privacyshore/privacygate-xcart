...
namespace XLite\Module\PrivacyGate\PrivacyGatePayment\Model\Payment\Processor;

/**
 * Payment processor for PrivacyGate
 */
class PrivacyGatePayment extends \XLite\Model\Payment\Base\WebBased
{
    /**
     * Constructor
     */
    protected function __construct()
    {
        ...
        \XLite\Module\PrivacyGate\PrivacyGatePayment\Main::includeLibrary();
    }
    ...
    {
        return 'modules/PrivacyGate/PrivacyGatePayment/config.twig';
    }
    ...
    protected function getFormURL()
    {
        ...
        \PrivacyGate\ApiClient::init($this->getSetting('app_key'));
    ...
    {
        return \XLite::getInstance()->getShopURL(
            \XLite\Core\Converter::buildURL('PrivacyGate_ipn', null, array(), \XLite::getCustomerScript()),
            \XLite\Core\Config::getInstance()->Security->customer_security
        );
    }
