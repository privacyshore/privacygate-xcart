<?php
namespace XLite\Module\PrivacyGate\PrivacyGatePayment\Controller\Customer;

use XLite\Module\CDev\Paypal\Model\Payment\Transaction;

class PrivacyGateIpn extends \XLite\Controller\Customer\ACustomer
{
    private $transaction;
    ...
    protected function doNoAction()
    {
        ...
        $charge = new \PrivacyGate\Resources\Charge($bodyArray['event']['data']);
    ...
    private function validateBody($body)
    {
        ...
        try {
            \PrivacyGate\Webhook::verifySignature($body, $signatureHeader, $secretKey);
